      ...
      <Row>
        ...
        <Col span="10">
          ...
          <div class="search">
            ...
            <a href="javascript:void(0);" class="iconfont icon-chazhao ficon_search S_ficon"></a>
          </div>
        </Col>
        <Col span="6">
          <!--头部导航部分-->
          <div class="gn_position">
            <div class="gn_nav">
              <ul class="gn_nav_list">
                <li><router-link to="/" class="S_txt1"><em class="S_txt1">首页</em></router-link></li>
                <li><router-link to="/" class="S_txt1"><em class="S_txt1">发现</em></router-link></li>
              </ul>
            </div>
            <div class="gn_login">
        ...
        <Col span="3">
          <!--用户设置显示部分-->
          <Row>
            <v-avatar size="40" v-if="this.$store.state.user" style="float: left;text-overflow: ellipsis">
  ...
  export default {
    name: "Header",
      ...
      methods:{
          handleSetClick(name){
              switch (name) {
                  case 'set':this.toSetPage();break;
                  case 'quit':this.userQuit();break;
              }
          },
          toSetPage(){
...
<style scoped>
  ...
  a:hover { color: #eb7350; text-decoration: none; }
  a {
    color: #eb7350;
